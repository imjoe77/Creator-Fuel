    ...
    >
      <input
        ...
        className="
          ...
          px-6 py-3 text-white placeholder-white/50
      ...
      {isOpen && results.length > 0 && (
        ...
        >
          {results.map((user) => (
            ...
            >
              <div
                className="flex items-center gap-3 px-4 py-3 cursor-pointer transition-colors hover:bg-purple-500/15"
      ...
      {isOpen && query.length >= 2 && results.length === 0 && (
        <div
          className="absolute left-0 right-0 mt-2 rounded-2xl p-4 text-center text-sm"
          style={{
            top: '100%',
            background: '#1e1b2e',
            border: '1px solid rgba(255,255,255,0.12)',
