...
const Navbar = () => {
 ...
 text-white flex items-center px-6">
      <img src='coffee.gif' className='w-20 h-20' /> <h1>Get Me a Coffee</h1>
      <ul className="flex gap-6 items-center ml-auto cursor-pointer">
        ...
        {session && <button href={"/profile"} onClick={() => signOut({ callbackUrl: "/" })} className="inline-block cursor-pointer  text-white bg-gradient-to-br from-purple-600 to-blue-500 
             hover:bg-gradient-to-bl focus:ring-4 focus:outline-none 
             focus:ring-blue-300 dark:focus:ring-blue-800 
